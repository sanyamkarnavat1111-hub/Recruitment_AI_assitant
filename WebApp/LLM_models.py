...
from LLM_shcemas import ExtractResumeDataSchema , ResumeAnalysis , QueryRouter , CreateSqlQuery , FixSqlQuery
...
llm_resume_analysis = chat_llm_ollama.with_structured_output(schema=ResumeAnalysis)
llm_router = chat_llm_ollama.with_structured_output(schema=QueryRouter)
llm_sql_query_generator = chat_llm.with_structured_output(schema=CreateSqlQuery)
llm_sql_fixer = chat_llm.with_structured_output(schema=FixSqlQuery)
